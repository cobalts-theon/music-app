...
└── models/
    ...
    ├── UserLibrarySong.js  # Junction table (User ↔ saved Song)
...
- Relations: hasMany Playlist, hasMany UserLibrarySong, hasMany RefreshToken
- Device-only data: listening history and downloads are stored with Android Room
